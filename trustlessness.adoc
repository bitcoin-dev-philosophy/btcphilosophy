...
// Kan du ge exempel på 'Super trusted'?
...
them safe, but verify to the best of his or her ability. That's how you remain as sovereign as possible and how Bitcoin prospers. The more eye-balls on the software, the less likely it is that security flaws slip through.
