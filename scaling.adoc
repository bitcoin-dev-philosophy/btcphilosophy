...
increase of the blockchain transaction capacity, others believe it is using the
...
demands [comm: I'm not entirely convinced by this line of reasoning; if you increase the block size limit thus the computational demand, you can either have full nodes upgrading their hardwares or just use many more of them, can't you?]. The downside is that it happens at the cost of
...
line is the latest, i.e. version 0.22, which was released in September 2021 and took 396 minutes
