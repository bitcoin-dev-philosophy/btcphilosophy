...
Andrew Poelstra
https://bitcoin.stackexchange.com/questions/29471/are-there-any-true-anonymous-cryptocurrencies?rq=1[explains
in a Bitcoin Stack Exchange post] what anonymity would look like:
