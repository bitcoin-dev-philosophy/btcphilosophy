...
This project is as a guide for new developers in Bitcoin to learn about the
digital currency's fundamental properties and how seasoned Bitcoin developers
think about them.
...
reading and briefly discuss each link.
...
The material presented is written by individuals who have studied Bitcoin for a
long time. The main authors are Kalle Rosenbaum and Linnéa Rosenbaum. This work
