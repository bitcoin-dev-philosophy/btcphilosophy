...
<<Appendix discussion>>::
<<Appendix build>>:: {empty}

:xrefstyle: {oldstyle}

Your feedback and contributions are most welcome! Instructions for
building and contributing can be found in <<Appendix build>>.
...
programs about Bitcoin development at https://learning.chaincode.com/[learn].

=== How is this organized?

The project is sectioned into chapters concerning different topics. Each
