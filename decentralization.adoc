...
[quote, wumpus, #bitcoin-core-dev IRC freenode]
____
1333560844|1|wumpus|bitcoin is neutral, which is a good thing, and the
...
* If Bitcoin wasn't permissionless, some authority would be needed to
  ...
  <<maxwelldecentralization,centralized>> system and Bitcoin would
  fall under censorship pressure.
